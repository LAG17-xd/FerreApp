...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtAge = findViewById(R.id.telefonoET);
        txtMail = findViewById(R.id.emailET);
        txtPass = findViewById(R.id.passwordET);
        txtCPass = findViewById(R.id.conPasswordET);
    }
    ...
    public void RegisterUser(View view){
        ...
        registrarUsuario("https://ferreteriaapppp.000webhostapp.com/cliente/registrar_usuario.php");
    }
